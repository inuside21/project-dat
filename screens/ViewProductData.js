...
// Entry Point
// ===============================================
export default function ViewProductData({ navigation, route }) {
  // Variable
  // ===========================
  const userData = route.params.data;
  const searchId = route.params.sid;      // id of equip or trade
  const searchMode = route.params.smode;  // 32 or 22
