...
// Entry Point
// ===============================================
export default function DashboardTrading({ navigation, route }) {
  // Variable
  // ===========================
            ...
            <View style={styles.mainContentBody}>
              ...
              <View style={styles.mainForm} >
                ...
                <View style={{ flex: 1, flexDirection: "row", justifyContent: "space-between", paddingTop: 25, marginHorizontal: 10, }}>
                  ...
                  <Text style={{ fontWeight: "bold", fontSize: 20, marginLeft: -50, color: "#fff" }}>Products Category</Text>
                  <Pressable onPress={() => navigation.navigate('TradingAdd', { data: userData })}>
                    <Image source={require('../assets/others/addnew.png')} style={{ height: 20, width: 90, justifyContent: "flex-end" }} />
                  </Pressable>
                </View>

                <View style={{ flex: 5, justifyContent: "flex-start", alignItems: "center", flexDirection: "row" }}>
                  <View style={{ flex: 1, alignItems: "center" }}>
                    <Pressable onPress={() => navigation.navigate('ViewProduct', { data: userData, sdata: "Seeds", smode: 23 })}>
                      <Image source={require('../assets/others/dd1.png')} style={{ width: 120, height: 120 }} />
                    </Pressable>
                  </View>

                  <View style={{ flex: 1, alignItems: "center" }}>
                    <Pressable onPress={() => navigation.navigate('ViewProduct', { data: userData, sdata: "Fruits", smode: 23 })}>
                      <Image source={require('../assets/others/dd2.png')} style={{ width: 120, height: 120 }} />
                    </Pressable>
                  </View>
                </View>
                ...
                <View style={{ flex: 5, justifyContent: "center", alignItems: "center", flexDirection: "row" }}>
                  <View style={{ flex: 1, alignItems: "center" }}>
                    <Pressable onPress={() => navigation.navigate('ViewProduct', { data: userData, sdata: "Vegetables", smode: 23 })}>
                      <Image source={require('../assets/others/dd3.png')} style={{ width: 120, height: 120 }} />
                    </Pressable>
                  </View>
