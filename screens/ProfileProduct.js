...
// Entry Point
// ===============================================
export default function ProfileProduct({ navigation, route }) {
  // Variable
  // ===========================
  ...
  function LoadProductList()
  {
    ...
    const urlReq = ConfigConnection.server + "api.php?mode=80";
    fetch(urlReq, {
      method: 'POST',
              ...
              <View style={styles.mainForm} >
                ...
                <Surface elevation={2} style={{ marginVertical: 10, height: 700 }}>
                  <View style={{ flex: 1, flexDirection: "row", justifyContent: "flex-start", marginVertical: 10, marginHorizontal: 10 }}>
                    ...
                    <Text style={{ fontWeight: "bold", fontSize: 20, marginLeft: 10 }}>List of posted products</Text>
                  </View>
