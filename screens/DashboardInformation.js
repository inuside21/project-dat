...
// Entry Point
// ===============================================
export default function DashboardInformation({ navigation, route }) {
  // Variable
  // ===========================
            ...
            <View style={styles.mainContentBody}>
              ...
              <View style={styles.mainForm} >
                ...
                <View style={{ flex: 1, flexDirection: "row", justifyContent: "space-between", paddingTop: 25, marginHorizontal: 10, }}>
                  ...
                  <Text style={{ fontWeight: "bold", fontSize: 20, marginLeft: -120, color: "#fff" }}>Information Section</Text>
                  <Pressable onPress={() => navigation.goBack()}>
                ...
                <View style={{ flex: 5, justifyContent: "flex-start", alignItems: "center", flexDirection: "row" }}>
                  <View style={{ flex: 1, alignItems: "center" }}>
                    <Pressable onPress={() => navigation.navigate('CalendarSeason', { data: userData })}>
                      <Image source={require('../assets/others/dd7.png')} style={{ width: 120, height: 120 }} />
                    </Pressable>
                  </View>

                  <View style={{ flex: 1, alignItems: "center" }}>
                    <Pressable onPress={() => navigation.navigate('PestView', { data: userData })}>
                      <Image source={require('../assets/others/dd8.png')} style={{ width: 120, height: 120 }} />
                    </Pressable>
                  </View>
                </View>
                ...
                <View style={{ flex: 5, justifyContent: "center", alignItems: "center", flexDirection: "row" }}>
                  <View style={{ flex: 1, alignItems: "center" }}>
                    <Pressable onPress={() => navigation.navigate('TopExchange', { data: userData })}>
                      <Image source={require('../assets/others/dd9.png')} style={{ width: 120, height: 120 }} />
                    </Pressable>
                  </View>
