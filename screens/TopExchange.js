...
// Entry Point
// ===============================================
export default function TopExchange({ navigation, route }) {
  // Variable
  // ===========================
  ...
  const calImg = [
    require("../assets/others/cal1.png"),
    require("../assets/others/cal2.png"),
    require("../assets/others/cal3.png"),
    require("../assets/others/cal4.png"),
    require("../assets/others/cal5.png"),
    require("../assets/others/cal6.png"),
    require("../assets/others/cal7.png"),
    require("../assets/others/cal8.png"),
    require("../assets/others/cal9.png"),
    require("../assets/others/cal10.png"),
    require("../assets/others/cal11.png"),
    require("../assets/others/cal12.png"),
  ]
  ...
  function LoadSearch()
  {
    ...
    const urlReq = ConfigConnection.server + "api.php?mode=130";
    fetch(urlReq, {
      method: 'POST',
              ...
              <View style={styles.mainForm} >
                ...
                <Surface elevation={2} style={{ marginVertical: 10, height: 700 }}>
                  <View style={{ flex: 1, flexDirection: "row", justifyContent: "flex-start", marginVertical: 10, marginHorizontal: 10 }}>
                    ...
                    <Text style={{ fontWeight: "bold", fontSize: 20, marginLeft: 10 }}>Top Exchange Calendar</Text>
                  </View>
                        ...
                        resultList.map(r => {
                          return (
                            <View style={{ backgroundColor: "#24AC64", width: 87, height: 100, marginVertical: 10, marginHorizontal: 15 }}>
                              <Pressable onPress={() => navigation.navigate('TopExchangeList', { data: userData, month: calMonth[r.month_number], monthindex: r.month_number })}>
                                <Image source={calImg[r.month_number]} style={{ height: "100%", width: "100%" }} />
                              </Pressable>
                            </View>
                          )
                        })
