...
// Entry Point
// ===============================================
export default function CalendarMonth({ navigation, route }) {
  // Variable
  // ===========================
  const userData = route.params.data;
  const seasonData = route.params.sdata;
  ...
  function LoadSearch()
  {
    ...
    const urlReq = ConfigConnection.server + "api.php?mode=51";
    fetch(urlReq, {
      method: 'POST',
              ...
              <View style={styles.mainForm} >
                ...
                <Surface elevation={2} style={{ marginVertical: 10, height: 700 }}>
                  <View style={{ flex: 1, flexDirection: "row", justifyContent: "flex-start", marginVertical: 10, marginHorizontal: 10 }}>
                    ...
                    <Text style={{ fontWeight: "bold", fontSize: 20, marginLeft: 10 }}>{ seasonData.season_name }</Text>
                  </View>
                        ...
                        resultList.map(r => {
                          return (
                            <View style={{ backgroundColor: "#24AC64", width: 87, height: 100, marginVertical: 10, marginHorizontal: 15 }}>
                              <Pressable onPress={() => navigation.navigate('CalendarProduct', { data: userData, sdata: r })}>
