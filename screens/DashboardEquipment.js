...
// Entry Point
// ===============================================
export default function DashboardEquipment({ navigation, route }) {
  // Variable
  // ===========================
            ...
            <View style={styles.mainContentBody}>
              ...
              <View style={styles.mainForm} >
                ...
                <View style={{ flex: 1, flexDirection: "row", justifyContent: "space-between", paddingTop: 25, marginHorizontal: 10, }}>
                  ...
                  <Text style={{ fontWeight: "bold", fontSize: 20, marginLeft: -30, color: "#fff" }}>Tools and Equipment</Text>
                  <Pressable onPress={() => navigation.navigate('EquipmentAdd', { data: userData })}>
                ...
                <View style={{ flex: 5, justifyContent: "flex-start", alignItems: "center", flexDirection: "row" }}>
                  <View style={{ flex: 1, alignItems: "center" }}>
                    <Pressable onPress={() => navigation.navigate('ViewProduct', { data: userData, sdata: "Farm Vehicles and Machinery", smode: 33 })}>
                      <Image source={require('../assets/others/dd4.png')} style={{ width: 120, height: 120 }} />
                    </Pressable>
                  </View>

                  <View style={{ flex: 1, alignItems: "center" }}>
                    <Pressable onPress={() => navigation.navigate('ViewProduct', { data: userData, sdata: "Farm Tools", smode: 33 })}>
                      <Image source={require('../assets/others/dd5.png')} style={{ width: 120, height: 120 }} />
                    </Pressable>
                  </View>
                </View>
